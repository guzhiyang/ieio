...
@property (nonatomic, assign, readonly) id<QBKOverlayMenuViewDelegate> delegate;
@property (nonatomic, assign) UIView *parentView;                                 // la vista que contendrá a este control
...
@property (nonatomic, retain, readonly) UIView *contentView;                    // contenedor de los botones adicionales
@property (nonatomic, retain, readonly) NSMutableArray *additionalButtons;      // colección de botones adicionales agregados por el usuario
