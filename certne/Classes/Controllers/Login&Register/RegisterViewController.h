...
@property (retain, nonatomic) UITextField       *inputNumberTextField;
@property (retain, nonatomic) UITextField       *inputPasswordTextField;
@property (retain, nonatomic) RegisterResponse  *registerResponse;
