...
//        [_toolBar setBackgroundImage:[UIImage imageNamed:@"toolbarBg.png"] forToolbarPosition:0 barMetrics:0];
//    }
//    else{
//        _toolBar.barStyle=UIToolbarPositionBottom;
//    }
...
{
    UIAlertView *alertView=[[UIAlertView alloc]initWithTitle:@"网址载入错误" message:@"网址打不开" delegate:self cancelButtonTitle:@"取消" otherButtonTitles:nil];
    [alertView show];
    [alertView release];
}
...
-(void)dealloc
{
    [userWebsiteView release];
    [websiteString release];
    [super dealloc];
}
@end
